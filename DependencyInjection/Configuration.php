...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('dugun_upload')
            ...
            ->example(['aws', 'dugun_image_microservice'])
            ->info('choose your uploader. dark side or light?? side!!!')
            ->validate()->ifNotInArray(array('aws', 'dugun_image_microservice'))->thenInvalid('Invalid uploader_type "%s"')->end()
            ->end()
            ...
            ->end()
            ->end()
            ->arrayNode('dugun_image_microservice')
            ->children()
